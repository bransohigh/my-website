...
const InfiniteGrid = () => {
  ...
  const gridSize = 22; // Fixed at 22px (dense)
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-3xl mx-auto space-y-6 pointer-events-none">
         <div className="space-y-2">
          <h1 className="text-4xl md:text-6xl font-semibold tracking-tight text-foreground drop-shadow-sm">
            Premium Software Solutions for Enterprise Growth
          </h1>
          <p className="text-lg md:text-xl font-semibold text-muted-foreground">
            At Welbii, we craft cutting-edge software that transforms your business. <br/>
            Innovative technology meets strategic excellence.
          </p>
        </div>
